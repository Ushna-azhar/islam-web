    ...
    <div>
      ...
      <div className="relative w-full h-screen">
        <video autoPlay loop muted className="object-cover w-full h-full absolute top-0 left-0">
          ...
          <p className="text-white text-xl">Your browser does not support the video tag, please update your browser.</p>
        </video>
      ...
      <button
        onClick={toggleTheme}
        className="fixed top-4 right-4 bg-gray-800 text-white p-2 rounded-full shadow-lg"
      >
