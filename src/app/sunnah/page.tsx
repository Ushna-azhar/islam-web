    ...
    <div className="bg-teal-50 text-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center space-y-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-teal-800 font-extrabold tracking-wider">
        ...
        <div className="mt-12 space-y-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-center text-teal-700">What is the Sunnah?</h2>
        ...
        <div className="mt-16 bg-teal-700 py-10 px-6 rounded-lg shadow-xl">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-center text-white mb-6">The Importance of Sunnah</h2>
        ...
        <div className="mt-16 space-y-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-center text-teal-800">Key Teachings from the Sunnah</h2>
        ...
        <div className="mt-16 bg-teal-600 py-10 px-6 rounded-lg shadow-xl">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-center text-white mb-6">The Sunnah in Our Daily Lives</h2>
        ...
        <div className="mt-16 text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-teal-700">The Sunnah: A Guide for Life</h2>
